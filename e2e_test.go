...
`
	...
	if err := mat.Install(context.Background(), lockfile, agents, installCfg, projectRoot, nil); err != nil {
...
func TestE2E_PackageOnly(t *testing.T) {
	...
	if err := mat.Install(context.Background(), lockfile, []model.AgentRef{{Name: "claude"}}, model.InstallConfig{}, projectRoot, nil); err != nil {
		t.Fatalf("install: %v", err)
	}
...
func TestE2E_FactoryParityLayout(t *testing.T) {
	...
	if err := mat.Install(context.Background(), lockfile, []model.AgentRef{{Name: "factory"}}, model.InstallConfig{}, projectRoot, nil); err != nil {
		t.Fatalf("install: %v", err)
	}
...
func TestE2E_OpenCodeParityLayout(t *testing.T) {
	...
	if err := mat.Install(context.Background(), lockfile, []model.AgentRef{{Name: "opencode"}}, model.InstallConfig{}, projectRoot, nil); err != nil {
		t.Fatalf("install: %v", err)
	}
...
func runMCPE2E(t *testing.T, projectRoot, cacheDir string, agentDef model.AgentDefinition, mcpOutputPath string) map[string]interface{} {
	...
	if err := mat.Install(context.Background(), lockfile, []model.AgentRef{{Name: agentDef.Name}}, model.InstallConfig{}, projectRoot, nil); err != nil {
		t.Fatalf("install: %v", err)
	}
...
func TestE2E_CopilotParityLayout(t *testing.T) {
	...
	if err := mat.Install(context.Background(), lockfile, []model.AgentRef{{Name: "copilot"}}, model.InstallConfig{}, projectRoot, nil); err != nil {
		t.Fatalf("install: %v", err)
	}
